...
<!--头部导航栏        -->
		...
		<div>
				...
				<ul id="Huifold1" class="Huifold">
					...
					<li class="item">
						...
						<div class="info">
							...
							<br>
							<a href="${pageContext.request.contextPath}/personal_studentbasic_schoolmanage" class="active">学生信息</a>
							<br>
			...
			<div id="main" style="margin-left:16.67%;padding:1px 16px;height:1000px;">
				<!--面包屑导航  -->
				<nav class="breadcrumb">个人资料<span class="c-666 en">&gt;</span><span class="c-666">学生信息</span></nav>
