...
<body>
	...
	<div>
		...
		<div id="menu">
			<ul id="Huifold1" class="Huifold">
				<li class="item">
					...
					<div class="info">
						<br> <a
							href="${pageContext.request.contextPath}/notice/showBankNotice_schoolmanage">银行公告</a>
						<br> <a
							href="${pageContext.request.contextPath}/notice/showSchoolNotice_schoolmanage?sm_id=<%=session.getAttribute("sm_id")%>"
							class="active">学校公告</a>
					</div>
				</li>
				<li class="item">
					...
					<div class="info">
						<a
							href="${pageContext.request.contextPath}/creditrequest/showAllRequest_schoolmanage?sm_id=<%=session.getAttribute("sm_id")%>">未审批</a>
						<br> <a
							href="${pageContext.request.contextPath}/creditrequest/showAllCompleteRequest_schoolmanage?sm_id=<%=session.getAttribute("sm_id")%>">已审批</a>
					</div>
				</li>
				<li class="item">
					<h4>
					...
					<div class="info">
						<a
							href="${pageContext.request.contextPath}/schoolmanage/showSchoolManageDetail_schoolmanage?sm_id=<%=session.getAttribute("sm_id")%>">基本资料</a>
					</div>
				</li>
			</ul>
		...
		<div id="main"
			...
			<!--面包屑导航  -->
			<nav class="breadcrumb">公告<span class="c-666 en">&gt;</span>
			<span class="c-666">学校公告</span></nav>

			<!--搜索框-->
			<br />
			<div class="clearfix">
				<form method="get"
					action="${pageContext.request.contextPath}/notice/search_school_schoolmanage">
					<input type="text" id="keyword" name="keyword" placeholder="请输入关键词"
						class="input-text ac_input" name="search_text" value=""
			...
			<table class="table table-border table-bordered table-hover">
				...
				%><tbody>
					<tr class="text-c">
						...
						<td><%=n_date%></td>
						<td><a
							href="${pageContext.request.contextPath}/notice/showSchoolNoticeDetail_schoolmanage?n_id=<%=notice.getN_id()%>"
							class="btn btn-primary radius size-MINI">查看</a></td>
						<td><a href="${pageContext.request.contextPath}/notice/showSchoolNoticeDetail_schoolmanage?n_id=<%=notice.getN_id()%>"
							class="btn btn-primary radius size-MINI">修改</a></td>
		...
		<script>
			...
			function delete_yes(){
				window.location.href = "${pageContext.request.contextPath}/notice/delete_schoolmanage?n_id="+id;
			}
		</script>
