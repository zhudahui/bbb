...
<!--头部导航栏        -->
		...
		<div>
			...
			<div id="menu">
				<ul id="Huifold1" class="Huifold">
					<li class="item">
						<h4>公告<b>+</b></h4>
						<div class="info">
							<a href="${pageContext.request.contextPath}/${pageContext.request.contextPath}/score/showScore_student?s_id=<%=session.getAttribute("s_id")%>">发布公告</a>
							<br>
					...
					<li class="item">
						...
						<div class="info">
							...
							<br>
							<a href="${pageContext.request.contextPath}/score/showScore_schoolmanage?sm_id=<%=session.getAttribute("sm_id")%>" class="active">学生成绩</a>
						</div>
					</li>
				</ul>
			...
			<div id="main" style="margin-left:16.67%;padding:1px 16px;height:1000px;">
				<!--面包屑导航  -->
				<nav class="breadcrumb">个人资料<span class="c-666 en">&gt;</span><span class="c-666">学生成绩</span></nav>
				
				<!--搜索框-->
				<br />
				<div class="clearfix">
					<form method="get" action="${pageContext.request.contextPath}/score/search_schoolmanage"><!--action="${pageContext.request.contextPath}/notice/search"-->
