...
<%@ page import="com.chinasofti.vo.Bank"%>
...
<!--头部导航栏        -->
		...
		<div>
			...
			<div id="menu">
				<ul id="Huifold1" class="Huifold">
					<li class="item">
						...
						<div class="info">
							<br>
							<a href="${pageContext.request.contextPath}/notice/showBankNotice_schoolmanage" class="active">银行公告</a>
							<br>
			...
			<div id="main" style="margin-left:16.67%;padding:1px 16px;height:1000px;">
				...
				<br />
				<div class="clearfix">
					<form method="get" action="${pageContext.request.contextPath}/notice/search_bank_schoolmanage">
				...
				<table class="table table-border table-bordered table-hover">
					<thead class="text-c">
						...
						<%
							ArrayList<Bank> bank = (ArrayList<Bank>) request.getAttribute("bank");
							...
							if (notice != null) {
								...
								for (int i = 0; i < notice.size(); i++) {
									...
									String n_title = n.getN_title();
									String b_name = b.getB_name();
									String n_date = n.getN_date();
						%><tbody>
						<tr class="text-c">
						<td><%=n_title%></td>
						<td><%=b_name%></td>
						<td><%=n_date%></td>
						<td><a href="${pageContext.request.contextPath}/notice/showBankNoticeDetail_schoolmanage?n_id=<%=n.getN_id()%>&n_author=<%=n.getN_author()%>" class="btn btn-primary radius size-MINI">查看</a></td>
						</tr>
						</tbody> 
						<%
									}
