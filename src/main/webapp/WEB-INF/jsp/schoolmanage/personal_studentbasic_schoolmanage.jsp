			...
			<div id="main" style="margin-left:16.67%;padding:1px 16px;height:1000px;">
				...
				<div class="clearfix">
					<form method="get" action="/search.do">
						...
						<!--添加用户按钮-->
						<a class="btn btn-primary radius" href="user_student_add_admin.html">添加用户</a>
					</form>
				</div>
				...
				<table id="student" class="table table-border table-bordered table-hover">
					...
					<tbody>
						...
						<tr class="text-c">
							...
							<td><a class="btn btn-primary radius size-MINI" href="${pageContext.request.contextPath}/student/showStudentDetail_schoolmanage?s_id=${student.getS_id() }">查看</a></td>
						</tr>
						</c:forEach>
					</tbody>
				</table>
