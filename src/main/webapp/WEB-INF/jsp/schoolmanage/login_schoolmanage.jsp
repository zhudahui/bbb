...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    	...
    	$(document).on("pageshow","#login_schoolmanage",function(){
		...
		if (flag == 1) {
			...
			form1.action = "${pageContext.request.contextPath}/schoolmanage/login";
			form1.submit();//提交
		}
		}
    	</script>
...
<br />
		...
		<form id="form1" class="mui-input-group" action="" method="post">
			<input name="sm_id" id="sm_id" type="text" class="login_input" placeholder="员工ID" />
			<br />
			<br />
			<input name="sm_pwd" id="sm_pwd" type="password" class="login_input" placeholder="密码" />
			<br />
			<br />
			<input id="login_schoolmanage" name="login_admin" class="login_button" type="button" value=" 立即登录 " onclick="checkLogin()" />
