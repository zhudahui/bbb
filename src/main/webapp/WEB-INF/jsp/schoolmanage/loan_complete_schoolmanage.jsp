...
<!--头部导航栏        -->
		...
		<div>
			...
			<br />
			<div class="clearfix">
				<form method="get" action="${pageContext.request.contextPath}/creditrequest/search_complete_schoolmanage">
			...
			<table class="table table-border table-bordered table-hover">
				...
				<tr class="text-c">
					...
					<td><%=requestdate%></td>
					<td><a
						href="${pageContext.request.contextPath}/creditrequest/showCompleteCreditRequestDetail_schoolmanage?r_id=<%=creditrequest.getR_id()%>&s_id=<%=creditrequest.getS_id()%>"
