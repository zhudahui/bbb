...
<!--头部导航栏        -->
		...
		<div>
			...
			<div id="main" style="margin-left:16.67%;padding:1px 16px;height:1000px;">
				...
				<br />
				<div class="clearfix">
					<form method="get" action="${pageContext.request.contextPath}/student/search_bankmanage">
				...
				<table id="student" class="table table-border table-bordered table-hover">
					...
					<tbody>
						...
						<tr class="text-c">
							...
							<td>${student.getS_loginFlag() }</td>
							<td><a class="btn btn-primary radius size-MINI" href="${pageContext.request.contextPath}/student/showStudentDetail_bankmanage?s_id=${student.getS_id() }">查看</a></td>
						</tr>
						</c:forEach>
					</tbody>
				</table>
