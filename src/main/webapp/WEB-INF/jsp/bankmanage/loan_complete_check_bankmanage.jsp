...
<!--头部导航栏        -->
		...
		<div>
				...
				<ul id="Huifold1" class="Huifold">
					...
					<li class="item">
						...
						<div class="info">
							...
							<br>
							<a href="${pageContext.request.contextPath}/creditrequest/showAllCompleteRequest_bankmanage?bm_id=<%=session.getAttribute("bm_id")%>" class="active">已审批</a>
						</div>
					</li>
					<li class="item">
						<h4>个人资料<b>+</b></h4>
			...
			<div id="main" style="margin-left:16.67%;padding:1px 16px;height:1000px;">
				<!--面包屑导航  -->
				<nav class="breadcrumb">贷款<span class="c-666 en">&gt;</span><span class="c-666">已审批</span></nav>
			...
			<div class="panel-body">
				<c:choose>
					<c:when test="${request.flag == 0}">
					</c:when>
					<c:otherwise>
						<c:if test="${request.flag == 2}">
							<div class="Huialert Huialert-success">
								<i class="Hui-iconfont">&#xe6a6;</i>申请已通过学校审核。
							</div>
						</c:if>
						<c:if test="${request.flag == 3}">
							<div class="Huialert Huialert-danger">
								<i class="Hui-iconfont">&#xe6a6;</i>申请未通过学校审核。
							</div>
						</c:if>
						<c:if test="${request.flag == 4}">
							<div class="Huialert Huialert-success">
								<i class="Hui-iconfont">&#xe6a6;</i>申请已通过银行审核。
							</div>
						</c:if>
						<c:if test="${request.flag == 5}">
							<div class="Huialert Huialert-danger">
								<i class="Hui-iconfont">&#xe6a6;</i>申请未通过银行审核。
							</div>
						</c:if>
						<c:if test="${request.flag == 6}">
							<div class="Huialert Huialert-success">
								<i class="Hui-iconfont">&#xe6a6;</i>申请通过学校自动审核。
							</div>
						</c:if>
						<c:if test="${request.flag == 7}">
							<div class="Huialert Huialert-danger">
								<i class="Hui-iconfont">&#xe6a6;</i>申请未通过学校自动审核。
							</div>
						</c:if>
						<c:if test="${request.flag == 8}">
							<div class="Huialert Huialert-success">
								<i class="Hui-iconfont">&#xe6a6;</i>申请通过银行自动审核。
							</div>
						</c:if>
						<c:if test="${request.flag == 9}">
							<div class="Huialert Huialert-danger">
								<i class="Hui-iconfont">&#xe6a6;</i>申请未通过银行自动审核。
							</div>
						</c:if>
					</c:otherwise>
				</c:choose>
			...
			<form action="" method="post" class="form form-horizontal"
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" value="${student.s_address}"
										...
										name="s_address" id="s_address" datatype="*" nullmsg="">
								</div>
								<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3">
								</div>
							</div>
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" value="${student.s_phone}"
										...
										name="s_phone" id="s_phone" datatype="*" nullmsg="">
								</div>
								<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3">
								</div>
							</div>
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" value="${student.s_postalCode}"
										...
										name="s_postalCode" id="s_postalCode" datatype="*" nullmsg="">
								</div>
								<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3">
								</div>
							</div>
					...
					<div class="panel-body" style="height: 320px;">
						...
						<div class="col-lg-2">
							<label>称谓：</label> <br /> <br /> <input type="text"
								...
								type="text" placeholder="称谓" value="${f1.f_nickname}"
				...
				<div class="panel panel-default mt-20">
					...
					<div class="panel-body">
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="date" value="${request.starttime}"
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="date" value="${request.deadline}"
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<textarea value="text" class="textarea radius" name="bankidea"
									id="bankidea" maxlength="300"
									onKeyUp="Huitextarealength(this)">${request.bankidea}</textarea>
								<p class="textarea-numberbar">
									<em class="textarea-length">0</em>/
									<am>300</am>
								</p>
				...
				<!-- <div class="row cl">
					<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3">
						...
						<a href="" class="btn btn-primary radius">&nbsp;&nbsp;通过&nbsp;&nbsp;</a>
						<a href="" class="btn btn-primary radius">&nbsp;&nbsp;拒绝&nbsp;&nbsp;</a>
					</div>
				</div> -->
				<!--调整布局  -->
