...
<!--头部导航栏        -->
		...
		<div>
			...
			<br />
			<div class="clearfix">
				<form method="get" action="${pageContext.request.contextPath}/creditrequest/search_notcomplete_bankmanage">
			...
			<table class="table table-border table-bordered table-hover">
				...
				<tr class="text-c">
					...
					<td><%=requestdate%></td>
					<td><a
						href="${pageContext.request.contextPath}/creditrequest/showCreditRequestDetail_bank?r_id=<%=creditrequest.getR_id()%>&s_id=<%=creditrequest.getS_id()%>"
