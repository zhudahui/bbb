...
<!--头部导航栏        -->
		...
		<div>
			...
			<br />
			<div class="clearfix">
				<form method="get" action="${pageContext.request.contextPath}/creditrequest/search_complete_bankmanage">
			...
			<table class="table table-border table-bordered table-hover">
				...
				<tr class="text-c">
					...
					<td><%=requestdate%></td>
					<td><a
						href="${pageContext.request.contextPath}/creditrequest/showCompleteCreditRequestDetail_bankmanage?r_id=<%=creditrequest.getR_id()%>&s_id=<%=creditrequest.getS_id()%>"
