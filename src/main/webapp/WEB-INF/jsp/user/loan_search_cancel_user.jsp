...
<!--头部导航栏        -->
		...
		<div>
			...
			<div id="menu">
				<ul id="Huifold1" class="Huifold">
					...
					<li class="item">
						<h4>预约挂号<b>+</b></h4>
						<div class="info">
							<a href="${pageContext.request.contextPath}/loan_request_student">预约</a>
							<br>
							<a href="${pageContext.request.contextPath}/creditrequest/showAllRequest_student?s_id=<%=session.getAttribute("s_id")%>" class="active">查询预约</a>
						</div>
					</li>
					<li class="item">
						<h4>个人资料<b>+</b></h4>
			...
			<div id="main" style="margin-left:16.67%;padding:1px 16px;height:1000px;">
				<!--面包屑导航  -->
				<nav class="breadcrumb">贷款<span class="c-666 en">&gt;</span><span class="c-666">查询申请</span></nav>
			</div>
