...
<!--头部导航栏        -->
		<header class="navbar-wrapper navbar-fixed-top">
			<div class="navbar navbar-black">
				<div class="container cl">
					...
					<a class="logo navbar-logo-m f-l mr-10 visible-xs" href="${pageContext.request.contextPath}/index">挂号预约</a>
		...
		<div>
			...
			<div id="menu">
				<ul id="Huifold1" class="Huifold">
					...
					<li class="item">
						<h4>个人资料<b>+</b></h4>
						<div class="info">
							<a href="${pageContext.request.contextPath}/student/showStudent_student?s_id=<%=session.getAttribute("s_id")%>" class="active">基本资料</a>
							<br>
			...
			<div id="main" style="margin-left:16.67%;padding:1px 16px;height:1000px;">
				...
				<!--基本资料   -->
				<!--可以更改的：政治面貌、家庭住址、电话号码、QQ号码、邮箱、年龄、专业、邮编、照片-->
				<form action="${pageContext.request.contextPath}/student/modifyProfile" method="post" class="form form-horizontal"
					id="demoform-2">
					...
					<div class="panel-body" style="height: 485px;">
						...
						<div class="col-sm-12 col-md-6">
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" class="input-text radius size-M"
										placeholder="姓名" name="s_name" id="s_name" disabled="disabled" datatype="*"
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" value="${student.s_IDcard}"
										...
										disabled="disabled" name="s_IDcard" id="s_IDcard" datatype="*18-18"
										nullmsg="请输入18位身份证号">
								</div>
								<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3">
								</div>
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" value="${student.s_politicalStatus}" disabled="disabled" class="input-text radius size-M"
						...
						<div class="col-sm-12 col-md-6">
							...
							<div class="row clearfix">
								...
								<div class="formControls col-xs-8">
									<div class="row clearfix" style="margin-top: 0">
										<div class="col-xs-6">
											<span class="select-box radius disabled"> <select
												disabled="disabled" class="select" size="1" name="s_gender" id="s_gender">
													<c:choose>
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" value="${student.s_age}" disabled="disabled" placeholder="年龄"
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" disabled="disabled" value="${student.s_major}" placeholder="专业"
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" value="${student.s_postalCode}" disabled="disabled"
