						...
						<div class="panel-body" style="height: 300px;">
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" readonly value="${schoolManage.sm_id}" class="input-text radius size-M" placeholder="id" name="smId" id="smId" datatype="*">
								</div>
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" value="${schoolManage.sm_pwd}" class="input-text radius size-M" name="smPwd" id="smPwd" datatype="*">
								</div>
								<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3"> </div>
							</div>
							<div style="height: 8px;"></div>
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" value="${schoolManage.sm_name}" class="input-text radius size-M" name="smName" id="smName" datatype="*">
								</div>
								<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3"> </div>
							</div>
							<div style="height: 8px;"></div>
							...
							<div class="row clearfix">
								<label class="form-label col-xs-3">所属学校：</label>
								<div class="formControls col-xs-8">
									<div class="row clearfix" style="margin-top: 0">
										<div class="col-xs-6">
										<span class="select-box">
										<select class="select" size="1" name="sm_school" id="sm_school" required>
												<option value="" selected>选择学校</option>
												<%
													ArrayList<School> school = (ArrayList<School>) request.getAttribute("all");
													SchoolManage schoolManage = (SchoolManage) request.getAttribute("schoolManage");
													if (school != null) {
														//遍历
														for (int i = 0; i < school.size(); i++) {
															...
															if(schoolManage.getSm_school().equals(sch_id)) {
												%>
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" value="${schoolManage.sm_phone}" class="input-text radius size-M" name="smPhone" id="smPhone" datatype="*">
								</div>
								<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3"> </div>
							</div>
							<div class="row cl">
								<label class="form-label col-xs-4 col-sm-3">审批权限：</label>
								<div class="formControls col-xs-8 col-sm-9">
									<select class="select" size="1" name="flag" id="sm_flag" required value="${schoolManage.flag}">
										<%
											SchoolManage sm1 = (SchoolManage) request.getAttribute("schoolManage");
											if(sm1.getFlag() == 1) {
											    %>
										<option value="1" selected>可审批</option>
										<option value="2">不可审批</option>
												<%
											} else {
										%>
										<option value="1">可审批</option>
										<option value="2" selected>不可审批</option>
										<%
											}
										%>
				...
				<div class="modal-content radius">
					...
					<div class="modal-footer">
						<a class="btn btn-primary radius"
							href="${pageContext.request.contextPath}/schoolmanage/delete_admin?sm_id=${schoolManage.sm_id}">确定</a>						
