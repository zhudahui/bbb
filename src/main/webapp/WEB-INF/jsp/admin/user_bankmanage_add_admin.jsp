<%@ page import="com.chinasofti.entity.Bankmanage" %>
		...
		<div>
			...
			<div id="main" style="margin-left:16.67%;padding:1px 16px;height:1000px;">
				...
				<nav class="breadcrumb">
					...
					<span class="c-666">银行用户</span>
					<span class="c-666 en">&gt;</span>
					<span class="c-666">添加用户</span>
				</nav>
				...
				<!--基本资料-->
				<form action="${pageContext.request.contextPath}/bankmanage/addBankmanage" method="post" class="form form-horizontal" id="demoform-2">
					<div class="panel panel-default mt-20">
						<div class="panel-header">银行管理员基本信息</div>
						<div class="panel-body">
							<!--ID-->
							<div class="row cl">
								<label class="form-label col-xs-4 col-sm-3">ID：</label>
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" placeholder="ID" class="input-text radius size-M" name="bmId" id="bmId" datatype="*" nullmsg="">
								</div>
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="password" class="input-text radius size-M" name="bmPwd" id="bmPwd" datatype="*" nullmsg="">
								</div>
								<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3"> </div>
							</div>
							<!--姓名-->
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" class="input-text radius size-M" name="bmName" id="bmName" datatype="*" nullmsg="">
								</div>
								<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3"> </div>
							</div>
							<!--银行ID-->
							<div class="row clearfix">
								<label class="form-label col-xs-3">银行ID：</label>
								<div class="formControls col-xs-8">
									<div class="row clearfix" style="margin-top: 0">
										<div class="col-xs-6">
										<span class="select-box">
										<select class="select" size="1" name="bmBank" id="bmBank" required>
												<option value="" selected>选择银行</option>
												<%
													ArrayList<Bankmanage> school = (ArrayList<Bankmanage>) request.getAttribute("all");
													if (school != null) {
														//遍历
														for (int i = 0; i < school.size(); i++) {
															Bankmanage sch = school.get(i);
															String sch_id = sch.getBmId();
															String sch_name = sch.getBmName();
												%>
							...
							<div class="row cl">
								...
								<div class="formControls col-xs-8 col-sm-9">
									<input type="text" class="input-text radius size-M" name="bmPhone" id="bmPhone" datatype="*" nullmsg="">
								</div>
								<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3"> </div>
							</div>
							<!--flag-->
							<div class="row clearfix">
								...
								<div class="formControls col-xs-8">
									<div class="row clearfix" style="margin-top: 0">
										<div class="col-xs-6">
										<span class="select-box">
										<select class="select" size="1" name="flag" id="flag" required>
