<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.chinasofti.vo.School"%>
...
<body>
	...
	<div>
		...
		<div id="menu">
			<ul id="Huifold1" class="Huifold">
				...
				<li class="item">
					...
					<div class="info">
						<a
							href="${pageContext.request.contextPath}/student/showAllStudent">用户管理</a>
						<br> <a
		...
		<div id="main"
			...
			<!--基本资料-->
			<form
				action="${pageContext.request.contextPath}/schoolmanage/add_admin"
				method="post" class="form form-horizontal" id="demoform-2"
				name="demoform-2">
				<div class="panel panel-default mt-20">
					<div class="panel-header">学校管理员基本信息</div>
					<div class="panel-body">
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="text" placeholder="ID"
									class="input-text radius size-M" name="sm_id" id="sm_id"
									required>
							</div>
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="password" class="input-text radius size-M"
									name="sm_pwd" id="sm_pwd" required>
							</div>
							<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3">
							</div>
						</div>
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="text" class="input-text radius size-M"
									name="sm_name" id="sm_name" required>
							</div>
							<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3">
							</div>
						</div>
												...
												<%
													...
													if (school != null) {
														...
														for (int i = 0; i < school.size(); i++) {
															...
															String sch_id = sch.getSch_id();
															String sch_name = sch.getSch_name();
												%>
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="text" class="input-text radius size-M"
									name="sm_phone" id="sm_phone" required>
							</div>
							<div class="col-xs-8 col-sm-6 col-xs-offset-4 col-sm-offset-3">
							</div>
						</div>
