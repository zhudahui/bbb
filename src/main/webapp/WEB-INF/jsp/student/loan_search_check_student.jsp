...
<body>
	...
	<div>
		...
		<div id="menu">
			<ul id="Huifold1" class="Huifold">
				<li class="item">
					...
					<div class="info">
						<a
							href="${pageContext.request.contextPath}/notice/showBankNotice_student">银行公告</a>
						<br> <a
		...
		<div id="main"
			...
			<!--面包屑导航  -->
			<nav class="breadcrumb">贷款<span class="c-666 en">&gt;</span> <span
				class="c-666">查询申请</span></nav>
					...
					<c:otherwise>
						<c:if test="${request.flag == 1}">
							<div class="Huialert Huialert-info">
								<i class="Hui-iconfont">&#xe6a6;</i>申请已提交，还未审核。
							</div>
						</c:if>
			...
			<form action="${pageContext.request.contextPath}/admin/updateCreditRequest" method="post" class="form form-horizontal"
				...
				<div class="panel panel-default mt-20">
					...
					<div class="panel-body">
						...
						<!--贷款用途-->
						<div class="row clearfix">
							<label class="form-label col-xs-3">贷款类别：</label>
							<div class="formControls col-xs-8">
								<div class="row clearfix" style="margin-top: 0">
									<div class="col-xs-6">
										<span class="select-box radius"> <select disabled class="select"
				...
				<div class="panel panel-default mt-20">
					...
					<div class="panel-body">
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<textarea readonly value="text" class="textarea radius" name="schoolidea"
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<textarea readonly value="text" class="textarea radius" name="bankidea"
		...
		<!--普通弹出层-->
			<div id="modal-demo-delete" class="modal fade middle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content radius">
						<div class="modal-header">
							<h3 class="modal-title">取消申请</h3>
						...
						<div class="modal-footer">
							<a class="btn btn-primary radius" href="${pageContext.request.contextPath}/creditrequest/delete_student?r_id=${request.r_id}">确定</a>
