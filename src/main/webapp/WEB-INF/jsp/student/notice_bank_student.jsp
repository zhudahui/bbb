...
<!--头部导航栏        -->
		...
		<div>
			...
			<div id="menu">
				<ul id="Huifold1" class="Huifold">
					<li class="item">
						<h4>公告<b>+</b></h4>
						<div class="info">
							<a href="${pageContext.request.contextPath}/notice/showBankNotice_student" class="active">银行公告</a>
							<br>
			...
			<div id="main" style="margin-left:16.67%;padding:1px 16px;height:1000px;">
				...
				<br />
				<div class="clearfix">
					<form method="get" action="${pageContext.request.contextPath}/notice/search_bank_student">
				...
				<table class="table table-border table-bordered table-hover">
					<thead class="text-c">
						...
						<td><%=b_name%></td>
						<td><%=n_date%></td>
						<td><a href="${pageContext.request.contextPath}/notice/showBankNoticeDetail_student?n_id=<%=n.getN_id()%>&n_author=<%=n.getN_author()%>" class="btn btn-primary radius size-MINI">查看</a></td>
						</tr>
						</tbody> 
						<%
									}
