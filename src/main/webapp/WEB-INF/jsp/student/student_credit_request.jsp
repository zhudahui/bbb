	...
	<div id="menu">
		<ul id="Huifold1" class="Huifold">
			...
			<li class="item">
				<h4>贷款<b>+</b></h4>
				<div class="info">
					<a href="${pageContext.request.contextPath}/student/student_credit_request" class="active">申请贷款</a>
					<br>
			...
			<div class="panel panel-default mt-20">
				...
				<div class="panel-body">
					...
					<div class="row cl">
						...
						<div class="formControls  skin-minimal col-xs-8 col-sm-9">
							<div class="check-box">
								<input type="radio" checked id="use-1" name="c.useType" required minlength="1" value="学费">
								<label for="use-1">学费(免息)</label>
							</div>
							<div class="check-box">
								<input type="radio" id="use-2" name="c.useType" value="创业">
								<label for="use-2">创业(年利率6.00%)</label>
							</div>
							<br/>
							<div class="check-box">
								<input type="radio" id="use-3" name="c.useType" value="生活">
								<label for="use-3">生活(年利率6.00%)</label>
							</div>
							<div class="check-box">
								<input type="radio" id="use-4" name="c.useType" value="其它">
								<label for="use-4">其它(年利率5.60%~6.55%)</label>
							</div>
						</div>
					</div>
					<!--申请原因-->
