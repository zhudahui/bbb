...
! function($) {
	$.fn.Huispinner = function(options, callback) {
		...
		this.each(function() {
			var that = $(this);
			var str = '<div class="spinner">' + '<a class="subtract" href="javascript:void(0)"><i>-</i></a>' + '<input class="amount input-text" value="' + options.value + '" autocomplete="off">' + '<a class="add" href="javascript:void(0)"><i>+</i></a>' + '</div>';
			that.append(str);
			...
			**************************************************/
			Slider.prototype = {
				...
				setValue: function(val, triggerSlideEvent) {
					...
					if (this.diff > 0) {
						this.percentage = [
							(this.options.value[0] - this.options.min) * 100 / this.diff, (this.options.value[1] - this.options.min) * 100 / this.diff,
